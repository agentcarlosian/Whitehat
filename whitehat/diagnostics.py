...
def doctor_result() -> dict[str, Any]:
    return {
        ...
        "capabilities": {
            ...
            "workspaceDependencyInspection": True,
            ...
            "captureRequestPreparation": True,
            "stagedRequestBinding": True,
            "evidenceLinkedPackets": True,
            "candidateRetestHistory": True,
            "accessScenarioCoverage": True,
            "concreteFuzzBatches": True,
            "scalarArrayFuzzGeneration": True,
            "graphqlInputObjectGeneration": True,
            "relationalEvidenceAssertions": True,
            "fuzzReductionAndCorpus": True,
            "finiteStateGeneration": True,
            "graphqlEvidenceAndPlanning": True,
            "optionalAtherisProfiles": True,
